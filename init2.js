...
d3.csv("data/dataWed2.csv", function(error, data) {
    ...
    .on("mouseover", function(d){
      ...
      tooltip
        .html(
          ...
          // "<p><strong>" + "To come:</strong> " + numberFormat(eval("d.clean_" + selectedYear)) + "</p>"
          );
...
//functions to call in individual bars
  function updateChart() {
    ...
    d3.selectAll(".bar1")
      .transition()
      .duration(0)
      .attr("x", function(d) {return Math.abs(x(eval("d.total_" + selectedYear)) - x(eval("d.crony_" + selectedYear))
    ...
    transition = svg.transition().duration(0),
      delay = 0;
  ...
  d3.selectAll(".bar")
    .on("mouseover", function(d){
      ...
      tooltip
        .html(
          "<h2><strong>" + "Year: </strong> " + (selectedYear) + "</h2>" +
          "<p><strong>" + "Billionaire wealth:</strong> " + numberFormat(eval("d.total_" + selectedYear)) + "</h2>"
